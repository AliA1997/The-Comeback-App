...
export function CategoryBadge({ category, small = false }: Props) {
  ...
  return (
    <View
      style={[styles.badge, { backgroundColor: c.bg }, small && styles.small]}
    >
      <Text
        style={[styles.text, { color: c.text }, small && styles.smallText]}
        numberOfLines={1}
      >
        {category}
      </Text>
...
const styles = StyleSheet.create({
  ...
  text: { fontSize: 12, fontFamily: 'Inter_600SemiBold', letterSpacing: 0.2 },
